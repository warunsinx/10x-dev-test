...
export default function CustomButton({
  ...
  return (
    <button
      ...
      } w-full rounded-xl flex items-center justify-center text-white hover:opacity-90 select-none`}
    >
      <p className="font-bold p-0 m-0 flex items-center justify-center">
        {isLoading ? (
          <svg
            role="status"
            className="w-7 h-7 text-white fill-flush-orange-500 animate-spin"
            viewBox="0 0 100 101"
            fill="none"
